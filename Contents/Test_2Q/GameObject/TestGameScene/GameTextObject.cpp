...
void GameTextObject::OnStart()
{
	...
	textRenderer2 = owner->AddComponent<TextRenderer>();
	...
	textRenderer3 = owner->AddComponent<TextRenderer>(); // 중앙 확인옹 텍스트
	textRenderer3->SetText(L"^");
	
	textRenderer4 = owner->AddComponent<TextRenderer>();
